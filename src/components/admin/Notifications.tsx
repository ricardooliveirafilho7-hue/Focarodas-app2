  ...
  return (
    <div className="p-4 md:p-8 h-[calc(100vh-4rem)] flex flex-col relative overflow-hidden">
      ...
      <div className="mb-8 relative z-10">
        ...
        <p className="text-white/40 text-sm mt-2 font-medium">Avisos e mensagens do sistema e clientes.</p>
      </div>
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-8 text-center border-2 border-dashed border-white/5 rounded-[2rem] bg-[#0A0A0A] relative z-10 shadow-2xl">
          <div className="w-24 h-24 bg-[#111] rounded-full flex items-center justify-center mb-6 shadow-inner border border-white/5">
              <Bell size={48} className="text-yellow-500 drop-shadow-[0_0_10px_rgba(234,179,8,0.3)]" />
          </div>
          <h3 className="text-3xl font-black text-white mb-3 tracking-tight">Central de Notificações</h3>
          <p className="text-white/40 font-medium max-w-md leading-relaxed">Você não tem notificações novas no momento. Os alertas do sistema e mensagens de clientes aparecerão aqui.</p>
      </div>
    </div>
  );
}
